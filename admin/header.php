...
<head>
    ...
    <title>QR Code Based Attedance Management System</title>

    <!-- Preloader -->
    <link rel="preload" href="../preloader.json" as="fetch" crossorigin="anonymous">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo11" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="viewdepartment.php">Manage Department</a>
                        
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo121"
                    aria-expanded="true" aria-controls="collapseTwo121">
                    <i class="fas fa-fw fa-laptop-code"></i>
                    <span>Courses</span>
                </a>
                <div id="collapseTwo121" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="managecourse.php">Manage Course</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="viewteacher.php">Manage Teacher</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="viewstudent.php">Manage Student</a>
