...
if($_GET['action']=='delete'){
    ...
    $query=mysqli_query($conn,"delete from tblcourses where id = $id ");
    if($query){
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <td><?php echo $row["course_name"]; ?></td>
                                    ...
                                    <td><center><a href="managecourse.php?action=delete&id=<?php echo $row['id']; ?>"><i class="fas fa-trash" style="color: red"></i></a></center></td>
                                </tr>
                        <?php
                            }
                        } else {
